 ...
 */
public class WordCountWChoice {
	public static class CounterBolt extends BaseRichBolt {
		private static final String GRAPHITE_METRICS_NAMESPACE_PREFIX = "zipf_26_26_WC";
	...
	public static void main(String[] args) throws Exception {
		...
		builder.setBolt("counter", new CounterBolt(),26).customGrouping("stream", new WChoiceGrouping());
