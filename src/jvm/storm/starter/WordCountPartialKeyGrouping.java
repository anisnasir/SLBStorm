...
public class WordCountPartialKeyGrouping {
	public static class CounterBolt extends BaseRichBolt {
		private static final String GRAPHITE_METRICS_NAMESPACE_PREFIX = "zipf_26_26_PKG";
		...
		{
			new File("/mnt/anis-logs/").mkdir();
			final MetricRegistry registry = new MetricRegistry();
			final CsvReporter reporter = CsvReporter.forRegistry(registry)
					.formatFor(Locale.US)
					.convertRatesTo(TimeUnit.MINUTES)
					.build(new File("/mnt/PKG/"));
	...
	public static void main(String[] args) throws Exception {
		...
		builder.setBolt("counter", new CounterBolt(),26).customGrouping("stream", new PartialKeyGrouping());
