 ...
 */
public class WordCountDChoice {
	public static class CounterBolt extends BaseRichBolt {
		private static final String GRAPHITE_METRICS_NAMESPACE_PREFIX = "zipf_26_26_DC";
	...
	public static void main(String[] args) throws Exception {
		...
		builder.setBolt("counter", new CounterBolt(),26).customGrouping("stream", new DChoiceGrouping());
